...
int main(int argc, char** argv) {
    ...
    calculateElementBeams(station, nr_antennas, itrfDirections, stationDirection, tileDirection, useDifferentialBeam, diffBeamDirection, subgrid_size, aTermBuffer, currentTime, centreFrequency);

    // Store aterm
    std::string aterms_filename("element-beams.fits");
